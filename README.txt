...
Tloona is deployed as a starkit and works with ActiveTcl 8.6 or Tclkit 8.6, on 
Windows and Mac OSX out of the box. It should also work on Linux with a decent 
ActiveTcl 8.6 installation, but binary dependencies are not included.

==

Release 2.0b3 : Date 2016/12/23 :
