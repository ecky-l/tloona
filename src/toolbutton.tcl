#
# $Id: toolbutton.tcl,v 1.1 2007/03/03 21:37:17 ecky-l Exp $
#
...
if {[lsearch [ttk::style theme names] step] >= 0} {
...
#
# ttk::style map default Toolbutton -width 0 -padding 1 -relief flat -borderwidth 2
